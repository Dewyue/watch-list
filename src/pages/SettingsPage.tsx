    ...
    <div>
      ...
      <section className="mb-6 rounded-2xl bg-white p-4 dark:bg-slate-900">
        ...
        <button
          ...
          className="mt-2 min-h-11 w-full rounded-xl bg-indigo-50 text-sm font-medium text-indigo-700 dark:bg-indigo-950 dark:text-indigo-300"
        >
          一键补全全部条目
        </button>
        {batchProgress && (
